...
{
	//cargamos la fuente
	if (!font.loadFromFile("Fonts/Pixel.otf")) {
	...
	mainMenu[1].setPosition(280, 110);
	...
	mainMenu[2].setPosition(300, 210);
	...
	mainMenu[3].setPosition(395, 310);
